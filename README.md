...
```bash
$ git clone -b v0.6.0-alpha https://github.com/instill-ai/model.git && cd model
...
| [Llava]([https://huggingface.co/mistralai/Mistral-7B-v0.1](https://huggingface.co/liuhaotian/llava-v1.5-13b))                                       | Text Generation                     | [GitHub-DVC](https://github.com/instill-ai/model-llava-13b-dvc)                                                                                                                                                                                              | PyTorch           | ❌   | ✅   |
